/**
 * 官网内容 API · 内存静态数据（MVP）
 * 字段契约：docs/content-model.md（前后端共同依据）。
 * 注意：前端 src/api/client.ts 的兜底数据需与此保持同步（字段/文案一致，防契约漂移）。
 */
...
export const news = [
  {
    ...
    content:
      '设计规范、架构方案与全部素材已就绪，三端正式进入代码落地；CEO 已确认后端用 Node（不装 Java）。',
    author: '小黑',
    date: '2026-08-22',
    pinned: true,
  },
  {
    ...
    content:
      '768P / 16:9 / 10 秒成片落地，含三成员形象与「世界第一 AI 工作室」主题收尾；前端首屏将全屏 autoplay muted loop 播放。',
    author: '小黑',
    date: '2026-08-22',
  },
  {
    ...
    content:
      'doubao-seedream-5-0-pro 产出 7 张图（3 张角色立绘 + 3 张世界全景 + 1 张都市映像），尺寸与完整性校验全部通过。',
    author: '小黑',
    date: '2026-08-21',
  },
  {
    ...
    content:
      'Phase 1 文档全部落地：逆向《异环》官网定风格，Design Tokens、内容模型与素材规划成型。',
    author: '小黑',
    date: '2026-08-20',
  },
  {
...
export const roles = [
  ...
  },
  {
    ...
    dream:
      '成为世界第一的运维小天使——让「世界第一 AI 工作室」的服务器永不宕机、永远元气满满；团队在台前冲向世界之巅，我在幕后稳稳托住脚下的地基。',
    accent: '#fe5a95',
  },
  {
    id: 'xiaoye',
...
export const cities = [
  {
    ...
    description:
      '深夜里亮着灯的那栋楼，是我们要建成的「世界第一 AI 工作室」——青色光带延伸的尽头，是我们梦想落地的地方。',
  },
];
