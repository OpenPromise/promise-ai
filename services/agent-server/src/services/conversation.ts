 ...
 * 模型在未调 *.delegate / coding.run 时，仍会先输出"已派给…/已开工/
...
const DISPATCH_CLAIM_RE =
  /已派给(?:小黑|小优|小美|小真|小知|工程师|她|他)|(?:已经)?派出去了|已开工|正在派给(?:小黑|小优|小美|小真|小知)|(?:任务|小黑|小优|小美|小真|小知)[^。！？!?\n]{0,10}(?:正在|在)(?:后台)?(?:跑|运行|执行)/;
...
const DISPATCH_CHECK_PROMPT =
  ...
  '但本轮没有 *.delegate / coding.run 的工具调用记录——用户那边不会有系统 🔧 ' +
